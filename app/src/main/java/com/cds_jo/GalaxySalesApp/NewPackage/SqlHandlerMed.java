...
public class SqlHandlerMed  {

    public static final String DATABASE_NAME = "/mnt/sdcard/Android/data/Galaxy/PhrDB.db";
    public static final int DATABASE_VERSION =1;
    Context context;
    SQLiteDatabase sqlDatabase;
    SqlDbMedHelper dbHelper;
    public SqlHandlerMed(Context context) {

        dbHelper = new SqlDbMedHelper(context, DATABASE_NAME, null,
                DATABASE_VERSION);
