...
public class Cls_UpdateData_AdapterMed extends BaseAdapter {
    Context context;
    ArrayList<Cls_UpdateDataMed> cls_updateDatas;

    public Cls_UpdateData_AdapterMed(Context context, ArrayList<Cls_UpdateDataMed> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        Cls_UpdateDataMed obj = cls_updateDatas.get(position);
