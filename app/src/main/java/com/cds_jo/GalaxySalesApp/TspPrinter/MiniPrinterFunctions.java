...
public class MiniPrinterFunctions {
	...
	public static void PrintSampleReceiptJp(Context context, String portName, String portSettings, String strPrintArea) {
		if (strPrintArea.equals("2inch (58mm)")) {
			...
			outputByteBuffer = createShiftJIS(context.getResources().getString(R.string.accept) + exsub.format(sub) + context.getResources().getString(R.string.accept) + extax.format(tax) + context.getResources().getString(R.string.accept) + exsub.format(sub) + "\n\n" + context.getResources().getString(R.string.accept) + "\n\n\n\n");
			list.add(outputByteBuffer);
