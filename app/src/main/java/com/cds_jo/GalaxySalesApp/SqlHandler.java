...
public class SqlHandler {
   // public static final String DATABASE_NAME = "/mnt/sdcard/Android/data/Galaxy/CVDB.db";
    ...
    public long  Insert( Context contex,String Table , String Col,ContentValues contentValues ) {
        long i = -1 ;
        try {
            ...
            Toast.makeText(contex,e.getMessage().toString(),Toast.LENGTH_SHORT).show();
            System.out.println("DATABASE ERROR" + contentValues);
        }
        return i ;
    }
