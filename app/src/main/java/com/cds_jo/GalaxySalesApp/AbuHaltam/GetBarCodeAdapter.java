...
public class GetBarCodeAdapter extends BaseAdapter {
    Context context;
    ArrayList<GetBarCode> contactList;

    public GetBarCodeAdapter(Context context, ArrayList<GetBarCode> contactList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        GetBarCode GetBarCode = contactList.get(position);
        if (convertView == null)
        {
