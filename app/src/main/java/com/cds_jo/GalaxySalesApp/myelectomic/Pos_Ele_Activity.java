package com.cds_jo.GalaxySalesApp.myelectomic;
...
import com.cds_jo.GalaxySalesApp.Pos.Cls_Inv_Item_Adapter;
import com.cds_jo.GalaxySalesApp.Pos.Cls_Item_Adapter;
import com.cds_jo.GalaxySalesApp.Pos.Cls_Pos_List_Items;
import com.cds_jo.GalaxySalesApp.Pos.MyAdapter;
import com.cds_jo.GalaxySalesApp.Pos.PopSavePosInvoice;
import com.cds_jo.GalaxySalesApp.Pos.Pop_Update_POS_Price;
import com.cds_jo.GalaxySalesApp.Pos.Pop_Update_POS_Qty;

import com.cds_jo.GalaxySalesApp.Pos.Pos_Activity;
import com.cds_jo.GalaxySalesApp.Pos.Pos_SearchActivity;
...
public class Pos_Ele_Activity extends AppCompatActivity implements  note_manFrg.ExampleDialogListener {
     EditText et_Discount, ed_Total, ed_AfterDiscount ,ed_bounse,et_Input;
    public int flagV;
    ...
    CheckBox chk_cus_name,chk_Move;
...
//
    ...
    public void updateManStore(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                CallWebServices ws = new CallWebServices(Pos_Ele_Activity.this);
...
//Toast.makeText(getApplicationContext(),"لم يتم التحديث",Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pos_ele_activity);
        update=(ImageButton)findViewById(R.id.update);
        tv_GSPN = (EditText) findViewById(R.id.tv_GSPN);
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        flagV =0;
        rdoPrecent = (RadioButton) findViewById(R.id.rdoPrecent);

        rdoAmt = (RadioButton) findViewById(R.id.rdoAmt);
//        rdoPrecent.setChecked(true);
        ...
        ed_bounse = (EditText) findViewById(R.id.ed_bounse);
        ed_Total = (EditText) findViewById(R.id.ed_Total);
        ed_AfterDiscount = (EditText) findViewById(R.id.ed_AfterDiscount);
        ...
        chk_Move = (CheckBox) findViewById(R.id.chk_Move);
        chk_Move.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(contactList.size()>0)
                {
                    Bundle bundle = new Bundle();
                    bundle.putString("Scr", "Pos_ele");
                ...
                else
                {
                    ...
                    IncludeTax_Flag.setEnabled(true);
                }
            }
        });
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager Manager = (Pos_Ele_Activity.this).getFragmentManager();
      ...
      /*  FragmentManager Frag_manger = getFragmentManager();
       ...
       /* if (ComInfo.ComNo == 1) {
            ...
            String NumOfInvPerVisit = DB.GetValue(Pos_Ele_Activity.this, "ComanyInfo", "NumOfInvPerVisit  ", "1=1");
        ...
        String RecVoucher_DocNo = DB.GetValue(Pos_Ele_Activity.this, "RecVoucher", "DocNo", "CustAcc ='" + accno.getText() + "' AND ((TrDate)=('" + currentDateandTime + "'))");
        String PAMENT_PERIOD_NO = DB.GetValue(Pos_Ele_Activity.this, "Customers", "PAMENT_PERIOD_NO", "no ='" + accno.getText() + "' ");
        ...
        String CUST_PRV_MONTH = DB.GetValue(Pos_Ele_Activity.this, "Customers", "CUST_PRV_MONTH", "no ='" + accno.getText() + "' ");
...
//        }
        ...
        if ((!ServerDate.equalsIgnoreCase(DeviceDate)) && ComInfo.ComNo == 4) {
            ...
            alertDialog.setButton("رجـــــــوع", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    BackInt = new Intent(Pos_Ele_Activity.this, JalMasterActivity.class);
            ...
            alertDialog.setButton("موافق", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    if (ExistAfterSacve == 1) {
                        ExistAfterSacve = 0;
                        Intent k = new Intent(Pos_Ele_Activity.this, JalMasterActivity.class);
                        startActivity(k);
                    }
                    if (DoPrint == 1) {
                        View view = null;
    ...
    private void CustAmtDt() {
        ...
        String NetTotal = DB.GetValue(Pos_Ele_Activity.this, "Customers", "CUST_NET_BAL", "no ='" + accno.getText() + "' ");

        String CustCelling = DB.GetValue(Pos_Ele_Activity.this, "Customers", "Celing", "no ='" + accno.getText() + "' ");
  ...
  /*  private void Calc_Dis_Hdr() {
    ...
    private void showList() {
        ...
        Cls_Sal_Inv_Adapter contactListAdapter = new Cls_Sal_Inv_Adapter(
                Pos_Ele_Activity.this, contactList);
    ...
    public void btn_searchCustomer(View view) {
        ...
        if (chk_Type.isChecked()) {
            ...
            if (u == "-1" || ComInfo.ComNo == 2|| ComInfo.ComNo== Companies.Sector.getValue() || ComInfo.ComNo== Companies.electronic.getValue() ) {
                Bundle bundle = new Bundle();
                bundle.putString("Scr", "POS_ele");
                FragmentManager Manager = getFragmentManager();
    ...
    public void CreateAlertDialogWithRadioButtonGroup(final String amt) {
        ...
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(Pos_Ele_Activity.this);
    ...
    private void Get_RequestPermission() {
        ...
        progressDialog = new ProgressDialog(Pos_Ele_Activity.this);
...
*/
        ...
        if (i > 0) {
            ...
            loadingdialog = ProgressDialog.show(Pos_Ele_Activity.this, "الرجاء الانتظار ...", "العمل جاري على طلب تفعيل سقف التسهيلات", true);
    ...
    private void CheckCelingOld(String Amt) {
        ...
        String Man = DB.GetValue(Pos_Ele_Activity.this, "Tab_Password", "ManNo", "PassNo = 8 AND ManNo ='" + UserID + "'");
        final String pass = DB.GetValue(Pos_Ele_Activity.this, "Tab_Password", "Password", "PassNo =8 and ManNo='" + Man + "'");


        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Pos_Ele_Activity.this);
        alertDialog.setTitle("رمز التحقق ");
        alertDialog.setMessage("لقد تجاوزت سقف التسهيلات للعميل ، سقف تسهيلات العميل هو " + Amt);

        final EditText input = new EditText(Pos_Ele_Activity.this);
    ...
    public void btn_save_po(final View view) {
        if(tv_GSPN.getText().toString().equals(""))
        {
            tv_GSPN.setError("required!");
            tv_GSPN.requestFocus();
            Toast.makeText(this,"يجب أدخال GSPN" ,Toast.LENGTH_SHORT).show();
            return;

        }
        CheckBox chk_Type =(CheckBox)findViewById(R.id.chk_Type);
        String HowPay = DB.GetValue(Pos_Ele_Activity.this, "Customers", "Pay_How", "no ='" + tv_acc.getText().toString() + "' ");
        if(HowPay.equals("1"))
        {
           /* if(chk_Type.isChecked())
            {
        ...
        String RecVoucher_DocNo = DB.GetValue(Pos_Ele_Activity.this, "RecVoucher", "DocNo", "CustAcc ='" + tv_acc.getText() + "' AND ((TrDate)=('" + currentDateandTime + "'))");
        String PAMENT_PERIOD_NO = DB.GetValue(Pos_Ele_Activity.this, "Customers", "PAMENT_PERIOD_NO", "no ='" + tv_acc.getText() + "' ");
            ...
            alertDialogYesNo.setPositiveButton("موافق", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    }else if ( ComInfo.ComNo == Companies.electronic.getValue())
                    {
                      ...
                      int  countsal = Integer.parseInt(DB.GetValue(Pos_Ele_Activity.this, "Sal_invoice_Hdr", "ifnull(count(*),0)", " date='" + currentDate + "'"));
                      if(countsal<3)
                      {
                        Save_Recod_Po();
                    }else
                      {
                          ...
                          String visitdate = DB.GetValue(Pos_Ele_Activity.this, "VisitDate", "Date", "Date='"+currentDateandTime+"'");
                          if (visitdate.equals("-1")) {
    ...
    public void Save_Recod_Po1() {
       /* SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        ...
        cv.put("Seq", Seq);
        cv.put("GSPN", tv_GSPN.getText().toString());
        if(chk_Move.isChecked())
        {
            cv.put("MOVE", "1");
        }
        else
      ...
      /*  if (chk_hdr_disc.isChecked()) {
        ...
        if (i > 0) {
            if(IsNew){
                ...
                InsertLogTrans obj=new InsertLogTrans(Pos_Ele_Activity.this,SCR_NO , SCR_ACTIONS.Insert.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"","0");

            }else{
                InsertLogTrans obj=new InsertLogTrans(Pos_Ele_Activity.this,SCR_NO , SCR_ACTIONS.Modify.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"","0");
            }
            UpDateMaxOrderNo();
            //DoPrint = 1;
            DeleteAllPromotions();
    ...
    private void ShowCodePop() {
        ...
        final Dialog dialog = new Dialog(Pos_Ele_Activity.this);
        dialog.setContentView(R.layout.fragment_code_dis_frg1);

        dialog.setCancelable(true);
        et_Input = (EditText) dialog.findViewById(R.id.et_Input);

        Button Update = (Button) dialog.findViewById(R.id.Update);
        Update.setTypeface(Typeface.createFromAsset(Pos_Ele_Activity.this.getAssets(), "Hacen Tunisia Lt.ttf"));
        Update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Show.setTypeface(Typeface.createFromAsset(Pos_Ele_Activity.this.getAssets(), "Hacen Tunisia Lt.ttf"));

        Button Accept = (Button) dialog.findViewById(R.id.Accept);
        Accept.setTypeface(Typeface.createFromAsset(Pos_Ele_Activity.this.getAssets(), "Hacen Tunisia Lt.ttf"));

        Button btnCancel = (Button) dialog.findViewById(R.id.Cancel);
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(Pos_Ele_Activity.this);
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    InputMethodManager inputMethodManager = (InputMethodManager) Pos_Ele_Activity.this.getSystemService(INPUT_METHOD_SERVICE);
                    inputMethodManager.hideSoftInputFromWindow(Pos_Ele_Activity.this.getCurrentFocus().getWindowToken(), 0);
            ...
            public void onClick(View v)
            {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        CallWebServices ws = new CallWebServices(Pos_Ele_Activity.this);
                        ws.Setcode_d(sharedPreferences.getString("UserID", ""),et_Input.getText().toString());
                        try {
                            Integer i;
                            String q;
                            JSONObject js = new JSONObject(We_Result.Msg);
                            ...
                            if( !(ID.get(0).toString().equals(""))) {
                                CodeOn = ID.get(0).toString();
                            ...
                            _handler.post(new Runnable() {
                                public void run() {
                                    ...
                                    {
                                        Toast.makeText(Pos_Ele_Activity.this,"الكود غير مطابق",Toast.LENGTH_LONG).show();
                                    }
                                    progressdialog.dismiss();
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        CallWebServices ws = new CallWebServices(Pos_Ele_Activity.this);
                        ws.Getcode_d(sharedPreferences.getString("UserID", ""));
                        try {
                            Integer i;
                            String q;
                            JSONObject js = new JSONObject(We_Result.Msg);
                            JSONArray BarCode = js.getJSONArray("Code");

                            if( !(BarCode.get(0).toString().equals(""))) {
                                CodeOn = BarCode.get(0).toString();
    ...
    private void ShowPrintPop() {

        final Dialog dialog = new Dialog(Pos_Ele_Activity.this);
        dialog.setContentView(R.layout.fragment_code_dis_frg2);
        ...
        final RadioButton radio_pirates,radio_ninjas;
        radio_ninjas =(RadioButton)dialog.findViewById(R.id.radio_ninjas);
        radio_pirates =(RadioButton)dialog.findViewById(R.id.radio_pirates);

        radio_ninjas.setChecked(true);
        radio_ninjas.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                radio_pirates.setChecked(false);
                radio_ninjas.setChecked(true);
        ...
        Accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
...

                    {
                       ...
                       int max1 =Integer.parseInt( DB.GetValue(Pos_Ele_Activity.this,"Sal_invoice_Hdr","count(*)","gspn = '"+et_Input.getText().toString()+"'"));
                        if (max1 >2)
                        {
                            Toast.makeText(Pos_Ele_Activity.this,"هناك العديد من الواتير لهذه GSPN",Toast.LENGTH_LONG).show();
                        }else if(max1 ==2)
                        {
                            Intent k = new Intent(Pos_Ele_Activity.this, Xprinter_SalesInvoice_ele.class);
                            k.putExtra("GSPN", et_Input.getText().toString());
                            k.putExtra("OrderNo", et_OrdeNo.getText().toString().replace("\u202c","").replace("\u202d",""));
                        ...
                        {
                            Intent    k = new Intent(Pos_Ele_Activity.this, Xprinter_SalesInvoice_eleb.class);
                        ...
                        {
                            Toast.makeText(Pos_Ele_Activity.this,"لا يوجد فواتير لهذه GSPN",Toast.LENGTH_LONG).show();
                        }
    ...
    public String GetMaxRecNo() {
        ...
        Integer max1=0;
        max1 =Integer.parseInt( DB.GetValue(Pos_Ele_Activity.this,"OrdersSitting","Payment","1=1"));
    ...
    private  void Insert_AutRecv(){
        ...
        String RecvOrder = "-1";
        RecvOrder= DB.GetValue(Pos_Ele_Activity.this,"RecVoucher" ,"ifnull(DocNo,'-1')","ifnull(SalesOrderNo,'-1')='" +pono.getText().toString()+"'");
...
*/
   ...
   /* SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
    ...
    public void showPop() {
        ...
        TextView accno = (TextView) findViewById(R.id.tv_acc);
        Bundle bundle = new Bundle();
        bundle.putString("Scr", "Sal_inv_ele");
...
//88
    ...
    public void Save_List(String ItemNo, String p, String q, String t, String u, String dis, String bounce, String ItemNm, String UnitName, String dis_Amt, String Operand,String Weight,String flag ,String f ) {
    ...
    public void Update_List(String ItemNo, String p, String q, String t, String u, String dis, String bounce, String ItemNm, String UnitName, String dis_Amt, String Operand,String Weight,String flag,String f) {
 ...
 /*       AlertDialog alertDialog = new AlertDialog.Builder(
    ...
    public void Delete_Record_PO() {
        ...
        InsertLogTrans obj=new InsertLogTrans(Pos_Ele_Activity.this,SCR_NO , SCR_ACTIONS.Delete.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"","0");
    ...
    public void Set_Order(String No) {
        ...
        FillAdapter();
        showList();
        String q = "Select  distinct  ifnull( s.hdr_dis_per,'0')  as   hdr_dis_per , ifnull( d.DriverNm,'') as drivernm, ifnull( s.hdr_dis_value,0) as hdr_dis_value ,s.Nm ,     s.inovice_type   ,s.include_Tax ,  s.disc_Total, s.OrderNo,s.Net_Total,s.Tax_Total ,s.acc ,s.date , c.name,s.MOVE,s.GSPN " +
        ...
        if (c1 != null && c1.getCount() != 0) {
            if (c1.getCount() > 0) {
             ...
             tv_GSPN.setText(c1.getString(c1.getColumnIndex("GSPN")));
                if(c1.getString(c1.getColumnIndex("MOVE")).equals("1"))
                {
                    chk_Move.setChecked(true);
                }
                else
                {
                    chk_Move.setChecked(false);
                }
    ...
    public void SaveDelveryNm(final View view) {
        ...
        final String DelveryNm = DB.GetValue(Pos_Ele_Activity.this, "Sal_invoice_Hdr", "DelveryNm", " ifnull(doctype,'1')='"+DocType.toString()+ "'  and  OrderNo   ='" + OrdeNo.getText().toString().replace("\u202c","").replace("\u202d","") + "'");
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (input.getText().toString().equalsIgnoreCase("")) {
                                ...
                                if (i > 0) {
                                    DoPrint(view);
                                    Toast.makeText(Pos_Ele_Activity.this, "تمت عملية تخزين مستلم البضاعة بنجاح  ", Toast.LENGTH_SHORT).show();
    ...
    public void btn_print(View view) {
        ImageButton imageButton2 = (ImageButton) findViewById(R.id.imageButton2);
        InsertLogTrans obj=new InsertLogTrans(Pos_Ele_Activity.this,SCR_NO , SCR_ACTIONS.Print.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"","0");
    ...
    private void DoPrint(View view)
    {
      ...
      /*  Cursor c1 = sqlHandler.selectQuery(q1);
        if (c1 != null && c1.getCount() != 0) {
            new SweetAlertDialog(Pos_Ele_Activity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
...
*/
    ...
    public void AppledOfferType32(String GroupNo, final String ItemFactor, final String TotalItem) {
        ...
        sqlHandler.executeQuery(q);
        builder = new AlertDialog.Builder(Pos_Ele_Activity.this);
    ...
    private  void DoShare(){
        InsertLogTrans obj=new InsertLogTrans(Pos_Ele_Activity.this,SCR_NO , SCR_ACTIONS.Share.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"","0");
        final SqlHandler sql_Handler = new SqlHandler(this);
        TextView pono = (TextView) findViewById(R.id.et_OrdeNo);
        final String Doc_No = pono.getText().toString();

        loadingdialog = ProgressDialog.show(Pos_Ele_Activity.this, "الرجاء الانتظار ...",    "العمل جاري على اعتماد  " +tv_ScrTitle.getText().toString(), true);
        loadingdialog.setCancelable(false);
        loadingdialog.setCanceledOnTouchOutside(false);
        loadingdialog.show();
        final Handler _handler = new Handler();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PostSalesInvoice obj = new PostSalesInvoice(Pos_Ele_Activity.this);
    ...
    */
    ...
    public void Set_Driver(String No, String Nm) {
        ...
        if (i > 0) {
            Toast.makeText(Pos_Ele_Activity.this, "تمت عملية تخزين السائق بنجاح  ", Toast.LENGTH_SHORT).show();
    ...
    public boolean discountcheck(double dis){
        ...
        for (int i=0;i<contactList.size();i++){
            ...
            String maxdis =DB.GetValue(Pos_Ele_Activity.this,"manf","MaxDiscount","man ='"+u+"'");
