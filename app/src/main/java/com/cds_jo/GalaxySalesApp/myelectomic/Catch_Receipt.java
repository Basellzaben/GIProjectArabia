...
import com.cds_jo.GalaxySalesApp.PopAddCheck2;
import com.cds_jo.GalaxySalesApp.PostTransActions.PostPayments;
import com.cds_jo.GalaxySalesApp.R;
import com.cds_jo.GalaxySalesApp.RecVoucherSearchActivity;
...
*/
    ...
    public void btn_SearchCust(View v) {
        ...
        bundle.putString("Scr", "RecVoch_ele");
    ...
    public void Save_Recod_Po() {
        ...
        cv.put("FromSales","0");
        cv.put("GSPN",et_ss.getText().toString());
        long i;
    ...
    public void ShowRecord() {
        ...
        String q = "Select  distinct rc.CheckTotal , rc.Cash, rc.Desc,rc.Amnt,rc.TrDate,rc.CustAcc  ,c.name , rc.curno  ,COALESCE(Post, -1)  as Post   ,rc.VouchType,rc.GSPN from RecVoucher rc   left join Customers c on c.no = rc.CustAcc  where rc.DocNo = '" + OrderNo.getText().toString().replaceAll("[^\\d.]", "")+ "'";
        SqlHandler sqlHandler = new SqlHandler(this);
        ...
        if (c1 != null && c1.getCount() != 0) {
            if (c1.moveToFirst()) {
                ...
                et_ss.setText(c1.getString(c1.getColumnIndex("GSPN")));
