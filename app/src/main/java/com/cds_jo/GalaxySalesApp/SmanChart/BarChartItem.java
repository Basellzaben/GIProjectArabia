...
public class BarChartItem extends ChartItem {
 ...
 //   private final Typeface mTf;
    ...
    public BarChartItem(ChartData<?> cd, Context c, ArrayList<Cls_Monthly_Items_Amount> list1) {
        super(cd);
        list=list1;
    ...
    public View getView(int position, View convertView, Context c) {
        ...
        { Cls_Monthly_Items_Amount cls_mp_chart=list.get(i);
            arrayList.add(cls_mp_chart.getType_Name());

        }

        if (convertView == null) {

            holder = new BarChartItem.ViewHolder();
            ...
            holder = (BarChartItem.ViewHolder) convertView.getTag();
        }
        ...
        a.setPosition(XAxis.XAxisPosition.TOP_INSIDE);
