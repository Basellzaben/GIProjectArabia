...
public class PreapareManQty extends AppCompatActivity {
    ...
    public void GetMaxPONo() {
        ...
        String max1 = "0";
        max1 = DB.GetValue(PreapareManQty.this, "OrdersSitting", "PrepareQty", "1=1");
    ...
    private void UpDateMaxOrderNo() {
        ...
        query = "Update OrdersSitting SET PrepareQty ='" + max + "'";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preaparemanqty);
...
*/
    ...
    public void InsertFromSales() {
        ...
        String query = " select Distinct Unites.UnitName,sid.unitNo, invf.Item_Name as Item_Name, sid.itemno as itemno ,sum( sid.qty) as qty  " +
                " from Sal_invoice_Det sid inner join Sal_invoice_Hdr sih on sih.OrderNo = sid.OrderNo" +
                " left join invf on invf.Item_No =  sid.itemno" +
                " left join Unites on Unites.Unitno=  sid.unitNo" +
                " where sih.date='" + currentDateandTime + "'" +
                " group by  sid.itemno,invf.Item_Name ";
        ...
        if (c1 != null && c1.getCount() != 0) {
            if (c1.moveToFirst()) {
                do {
                    ...
                    contactListItems.setno(c1.getString(c1.getColumnIndex("itemno")));
