...
public class Sales_Invoices_Report2 extends AppCompatActivity {
    ...
    TextView tv  ;
    TextView updatedata;
    ArrayList<Sale_Invoice_Rep2_Model> lista;
    String u;
    ImageView clear;

    @Override
    public void onBackPressed() {
        Intent k = new Intent(Sales_Invoices_Report2.this, JalMasterActivity.class);
        startActivity(k);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_invoices_report2);
        ...
        to.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(Sales_Invoices_Report2.this,
        ...
        recycler.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                bundle.putString("OrderNo", lista.get(i).getItemWeight()+""  );
   ...
   /* public void btn_searchCustomer(View view) {
    ...
    public void getdata(final String CustNo1, final String FromDate,final String ToDate,final String UserNo){
        ...
        progressDialog = new ProgressDialog(Sales_Invoices_Report2.this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                CallWebServices ws = new CallWebServices(Sales_Invoices_Report2.this);
                ws.GetManSalesRepH2(CustNo1,FromDate,ToDate,UserNo);
                try {
                    Integer i;
                    String q = "";
                    ...
                    if (We_Result.ID > 0) {
                        ...
                        for (i = 0; i < Type_Name.length(); i++) {
                            ...
                            Sale_Invoice_Rep2_Model repModel=new Sale_Invoice_Rep2_Model();
                            repModel.setQTY(QTY.get(i).toString());
                            repModel.setItemWeight(ItemWeight.get(i).toString());
                            repModel.setType_Name(Type_Name.get(i).toString());
                        ...
                        _handler.post(new Runnable() {
                            public void run() {
                                try {
                                    progressDialog.dismiss();
                                    Sales_Invoice_Rep2_Adapter reportAdapter = new Sales_Invoice_Rep2_Adapter(
                                            Sales_Invoices_Report2.this,R.layout.row_grid, lista);
                        ...
                        _handler.post(new Runnable() {
                            public void run() {
                                try {
                                    progressDialog.dismiss();
                                    Toast.makeText(Sales_Invoices_Report2.this,"لا يوجد بيانات",Toast.LENGTH_SHORT).show();
                                } catch (Exception df) {
                                }
                            }
                        });
                    ...
                    _handler.post(new Runnable() {
                        public void run() {
                            try {
                                progressDialog.dismiss();
                                Toast.makeText(Sales_Invoices_Report2.this,"حدثت مشكلة اثناء جلب البيانات",Toast.LENGTH_SHORT).show();
                            } catch (Exception d) {
                            }
                        }
                    });
