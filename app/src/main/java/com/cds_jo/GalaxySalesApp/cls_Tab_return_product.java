...
public class cls_Tab_return_product extends BaseAdapter {

    Context context;
    ArrayList<cls_Tab_Sales> cls_Tab_Sales;

    public cls_Tab_return_product(Context context, ArrayList<cls_Tab_Sales> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if(cls_search_po.getType()==null){
            ...
            } else if (cls_search_po.getType().equals("0") || cls_search_po.getType().isEmpty()) {
        ...
        if (cls_search_po.getPaymentNo().equalsIgnoreCase("-1")){

            RR.setBackgroundColor(context.getResources().getColor(R.color.Red));
