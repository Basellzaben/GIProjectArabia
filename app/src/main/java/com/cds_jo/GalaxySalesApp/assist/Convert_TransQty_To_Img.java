...
public class Convert_TransQty_To_Img extends AppCompatActivity {
    ...
    private void showList() {
        ...
        String  query = "Select distinct ms.ser, ms.docno ,ms.StoreName , ms.itemno , invf.Item_Name   ,Unites.UnitName     ,ms.qty  ,ms.des ,  ms.date    from  ManStore  ms left join invf on invf.Item_No =  ms.itemno    left join Unites on Unites.Unitno=  ms.UnitNo    ";
    ...
    public void btn_back(View view) {
         ...
         Intent k = new Intent(Convert_TransQty_To_Img.this, JalMasterActivity.class);
        startActivity(k);
    }
