...
import com.cds_jo.GalaxySalesApp.Device;
...
public class Convert_Prapre_Qty_To_Img extends AppCompatActivity {
    ...
    private void showList() {
        ...
        contactList.clear();
        Intent i = getIntent();
        String query     = "  select Distinct Unites.UnitName,  invf.Item_Name, pod.itemno,pod.price,pod.qty,pod.tax ,pod.unitNo , invf.Weight from PrepManQtydetl pod left join invf on invf.Item_No =  pod.itemno    left join Unites on Unites.Unitno=  pod.unitNo  " +
                "Where pod.orderno='" +  i.getStringExtra("DocNo").toString()+ "' order by invf.Weight ";
    ...
    public void btn_back(View view) {
         ...
         Intent k = new Intent(Convert_Prapre_Qty_To_Img.this, JalMasterActivity.class);
        startActivity(k);
    }
