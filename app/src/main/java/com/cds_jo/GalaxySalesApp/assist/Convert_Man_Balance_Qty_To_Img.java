...
public class Convert_Man_Balance_Qty_To_Img extends FragmentActivity {
    ...
    public void btn_back(View view) {
         ...
         Intent k = new Intent(Convert_Man_Balance_Qty_To_Img.this, JalMasterActivity.class);
        startActivity(k);
    }
    ...
    public void Do_P(View view) {
        ...
        ComInfo.ComNo = Integer.parseInt(DB.GetValue(Convert_Man_Balance_Qty_To_Img.this, "ComanyInfo", "CompanyID", "1=1"));


        if(  ComInfo.ComNo==4) {


            PrintReport_PR3 PR3 = new PrintReport_PR3(Convert_Man_Balance_Qty_To_Img.this,
