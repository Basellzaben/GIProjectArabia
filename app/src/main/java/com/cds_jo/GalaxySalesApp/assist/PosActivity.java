...
public class PosActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(netReciever,new IntentFilter(Bluetooth.DISCONNECT));
    ...
    private void printText(){
        ...
        Bluetooth.binder.writeDataByYouself(
                new UiExecute() {
                    @Override
...
//                            list.add( DataForSendToPrinterPos58.initializePrinter());
    ...
    private void printBarcode(){
        Bluetooth.binder.writeDataByYouself(new UiExecute() {
            @Override
            public void onsucess() {
...
//                list.add(DataForSendToPrinterPos80.printAndFeedForward(3));
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 2:
                    ...
                    if (PosPrinterDev.PortType.USB!=Bluetooth.portType){
                        printpicCode(b2);
                    }else {
    ...
    private void checklink(){
        Bluetooth.binder.checkLinkedState(new UiExecute() {
            @Override
            public void onsucess() {
    ...
    private class Receiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Bluetooth.DISCONNECT)){
                Message message=new Message();
                message.what=4;
                handler.handleMessage(message);
            }
