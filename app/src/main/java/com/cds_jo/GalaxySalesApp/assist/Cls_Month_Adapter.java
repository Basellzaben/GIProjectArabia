 ...
 */
public class Cls_Month_Adapter extends BaseAdapter{
    Context context;
    ArrayList<Cls_Cur> cls_curs;


    public Cls_Month_Adapter(Context context, ArrayList<Cls_Cur> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.monthrow, null);
