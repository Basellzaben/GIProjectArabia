 ...
 */
public class Cls_Inv_Deptf_Adapter extends BaseAdapter {

    Context context;
    ArrayList<Cls_Deptf> cls_deptfs;


    public Cls_Inv_Deptf_Adapter(Context context, ArrayList<Cls_Deptf> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.deptf_row_old, null);
