 ...
 */
public class cls_Search_TransQty_adapter extends BaseAdapter {

    Context context;
    ArrayList<cls_Search_TransQty> cls_search_pos;

    public cls_Search_TransQty_adapter(Context context, ArrayList<cls_Search_TransQty> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.trans_qty_row_search, null);
        ...
        MyTextView tv_ToStore = (MyTextView) convertView.findViewById(R.id.tv_ToStore);
        tv_ToStore.setText(obj.getToStore());
