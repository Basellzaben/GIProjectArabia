 ...
 */
public class Cls_Po_Item_List_Adapter extends BaseAdapter {

    Context context;
    ArrayList<Cls_Invf> cls_invfs;


    public Cls_Po_Item_List_Adapter(Context context, ArrayList<Cls_Invf> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.po_items_list_row, null);
