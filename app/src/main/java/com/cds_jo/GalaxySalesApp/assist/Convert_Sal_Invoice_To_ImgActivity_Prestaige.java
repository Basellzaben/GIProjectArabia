...
public class Convert_Sal_Invoice_To_ImgActivity_Prestaige extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sal_inv_to_img_prestaige); //
...
/*
                ...
                if (PrinterType.equals("1")) {
                    ...
                    if (Company.equals("1") || Company.equals("2")) {
                        PrintReport_SEWOO_ESCPOS ObjPrint = new PrintReport_SEWOO_ESCPOS(Convert_Sal_Invoice_To_ImgActivity_Prestaige.this,
                                Convert_Sal_Invoice_To_ImgActivity_Prestaige.this, lay, 570, 1);
             ...
             //   if (PrinterType.equals("2")) {
                    PrintReport_Zepra520 obj =  new PrintReport_Zepra520(Convert_Sal_Invoice_To_ImgActivity_Prestaige.this,
                            Convert_Sal_Invoice_To_ImgActivity_Prestaige.this,lay,560,1);
                    obj.DoPrint();
                //}
    ...
    public  void ShowRecord( String OrdNo){
        ...
        TextView textView236 =(TextView)findViewById(R.id.textView236);
        ...
        textView236.setBackground(shape);
        ...
        String q = "Select distinct  ifnull(s.DelveryNm,'') as  DelveryNm , s.include_Tax, s.inovice_type , s.Total , s.Nm,  s.disc_Total, s.OrderNo,s.Net_Total,s.Tax_Total ,s.acc ,s.date , c.name  " +
...
*/
    ...
    private void showList(String OrderNo) {
        ...
        contactList.clear();
        sqlHandler = new SqlHandler(this);
        String query = "SELECT  distinct sid.itemNo,sid.OrgPrice ,sid.price,sid.tax,u.UnitName  , sid.tax_Amt,  ( ifnull(sid.qty,0) +  ifnull(sid.Pro_bounce,0)  )  as qty, " +
                " ifnull(bounce_qty,0) as bounce_qty   ,invf.Item_Name  ,  sid.total    " +
        ...
        tv_Dis_amt.setText(SToD(Dis_Amt.toString()) + "");
            ...
            for (ContactListItems Obj : contactList){
                    ...
                    view = inflater.inflate(R.layout.sal_inv_row_prastaige, null);
                ...
                tv_bounce = (TextView) view.findViewById(R.id.tv_bonce);



                tv_no.setText(Obj.getDis_Amt());
                ...
                tv_tax.setText(Obj.getTax());
                tv_bounce.setText(Obj.getBounce());
