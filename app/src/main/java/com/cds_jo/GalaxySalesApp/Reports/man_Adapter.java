...
public class man_Adapter  extends BaseAdapter {
    Context context;
    ArrayList<cls_man> customerses;

    public man_Adapter(Context context, ArrayList<cls_man> list) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        cls_man customersesobj = customerses.get(position);
