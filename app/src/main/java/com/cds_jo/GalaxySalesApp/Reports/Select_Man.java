...
public class Select_Man extends DialogFragment implements View.OnClickListener  {
    ...
    public View onCreateView(final LayoutInflater inflater   , ViewGroup container  , Bundle savestate) {
        ...
        form = inflater.inflate(R.layout.layout_select_man, container, false);
        ...
        items_Lsit.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                ...
                if (getArguments().getString("Scr") == "Rep_Man") {
                    ((Report_Home) getActivity()).Set_Man(customers.getNo(), customers.getName());
    ...
    public void onProgressUpdate(String t ){
        ...
        ArrayList<cls_man> customersesList = new ArrayList<cls_man>();
        if (c!=null && c.getCount()!=0 ){
            if(c.moveToFirst()){
                do{
                    cls_man     customers = new cls_man();

                    customers.setNo(c.getString(c.getColumnIndex("no")));
                    customers.setName(c.getString(c.getColumnIndex("name")));
        ...
        man_Adapter Customer_List_adapter = new man_Adapter(
