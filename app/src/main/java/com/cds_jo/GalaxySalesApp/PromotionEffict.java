 ...
 public void onClick(View v) {
     ...
     if( ItemNo.toString().length() == 0 ) {
         ...
         if (getArguments().getString("Scr") == "po") {
                ((OrdersItems) getActivity()).Save_List(ItemNo, Price.getText().toString(), qty.getText().toString(), tax.getText().toString(), UnitNo, disc_per.getText().toString(), bounce.getText().toString(),str,UnitName,disc_Amt.getText().toString(),"","","",Price.getText().toString());
                Price.requestFocus();
         }
