...
try {
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS  SaleManRounds ( no integer primary key autoincrement, ManNo text null, CusNo text null  , DayNum integer null , Tr_Data  text null ,Start_Time text null ,End_Time text null, Duration Text null,Closed Text Null  , Posted integer null ) ");
  ...
  db.execSQL(" CREATE TABLE IF NOT EXISTS Po_dtl ( no integer primary key autoincrement,orderno text null, itemno text null" +
    ...
    db.execSQL(" CREATE TABLE IF NOT EXISTS Sal_invoice_Hdr ( no integer primary key autoincrement,OrderNo text null , Nm text null , acc text null ,date text null,UserID INTEGER null,Post INTEGER null ,   hdr_dis_per text null ,hdr_dis_value text null" +
            " , QtyStoreSer  integer null , Total Text null , Net_Total text Null ,Tax_Total  text null , bounce_Total text null, include_Tax text null  , disc_Total text null ,inovice_type text null ) ");
  ...
  db.execSQL("CREATE TABLE IF NOT EXISTS Sal_invoice_Det ( no integer primary key autoincrement, OrderNo text null, itemNo text null,unitNo text null  , price text null ,qty text null ,tax text null  ,UserID INTEGER null ,Post INTEGER null   ,dis_Amt text null ,dis_per text null," +
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS ComanyInfo ( ID integer primary key autoincrement, CompanyID integer null, CompanyNm text null,UserNm text null  , TaxAcc1 text null ,TaxAcc2 text null ,Notes text null  ,Address text null ,ComanyInfo text null )");
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS RecVoucher ( ID INTEGER PRIMARY KEY AUTOINCREMENT,DocNo NUMERIC,CustAcc TEXT,Amnt REAL,TrDate TEXT,Desc TEXT,UserID NUMERIC null,Post INTEGER null ,VouchType INTEGER null , curno text null , Cash text null ,CheckTotal text null  ) ");
    db.execSQL("CREATE TABLE IF NOT EXISTS RecVoucherSeles ( ID INTEGER PRIMARY KEY AUTOINCREMENT,DocNo NUMERIC,CustAcc TEXT,Amnt REAL,TrDate TEXT,Desc TEXT,UserID NUMERIC null,Post INTEGER null ,VouchType INTEGER null , curno text null , Cash text null ,CheckTotal text null  ) ");
    ...
    db.execSQL("CREATE TABLE IF NOT EXISTS CASHCUST ( ID integer primary key autoincrement, No text null, Name text null,veName text null ,UserID text null )" );
...
*/
        ...
        try {
            ...
            db.execSQL("Alter Table Sal_invoice_Det  Add Column  Operand  text null ");
