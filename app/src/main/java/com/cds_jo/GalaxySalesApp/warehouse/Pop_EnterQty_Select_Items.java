...
public class Pop_EnterQty_Select_Items extends DialogFragment implements View.OnClickListener {
...
// safety check
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savestate) {
        ...
        form = inflater.inflate(R.layout.pop_enter_qty_select_items, container, false);
    ...
    public void onClick(View v) {
        ...
        if (v == add) {
            ...
            if (getArguments().getString("Scr") == "EnterQty") {
              ((EnterQtyActivity) getActivity()).Save_List(ItemNo, str,  qty.getText().toString(),  UnitNo,UnitName ,Operand );
