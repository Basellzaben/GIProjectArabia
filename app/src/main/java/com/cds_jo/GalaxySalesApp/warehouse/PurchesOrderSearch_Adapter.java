...
public class PurchesOrderSearch_Adapter extends BaseAdapter {
    Context context;
    ArrayList<Cls_PurchesOrderSearch> clsSystemCodes;

    public PurchesOrderSearch_Adapter(Context context, ArrayList<Cls_PurchesOrderSearch> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        Cls_PurchesOrderSearch obj = clsSystemCodes.get(i);

        if (view == null) {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.search_purches_order_row, null);
        }
        ...
        tv_no.setText(obj.getOrderNo());
        tv_desc.setText(obj.getDate());
