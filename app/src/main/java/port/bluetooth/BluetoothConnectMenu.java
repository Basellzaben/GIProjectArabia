...
import com.cds_jo.GalaxySalesApp.assist.AlertView;
...
public class BluetoothConnectMenu extends FragmentActivity
{
	...
	EditText     Sal_inv ,Payments,PrepQty,SalesOrder,ReturnQty,CustCash;
	...
	public void onCreate(Bundle savedInstanceState)
	{
	   ...
	   IP.setText(sharedPreferences.getString("ServerIP", "0"));
		...
		Sal_inv.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","Sales","1=1"));
		Payments.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","Payment","1=1"));
		PrepQty.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","PrepareQty","1=1"));
		SalesOrder.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","SalesOrder","1=1"));
		ReturnQty.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","ReturnQty","1=1"));
		CustCash.setText(DB.GetValue(BluetoothConnectMenu.this,"OrdersSitting","CustCash","1=1"));
	...
	public void DeleteAll(View view) {
		...
		alertDialog.setPositiveButton("نعم", new DialogInterface.OnClickListener() {
			...
			//	sqlHandler.executeQuery("Delete from manf");
				...
				sqlHandler.executeQuery("UPDATE    OrdersSitting set Sales =0 ,SalesOrder=0,PrepareQty=0,RetSales=0,CustCash=0,ReturnQty=0");
				sqlHandler.executeQuery("Delete from Offers_Hdr");
	...
	public void btn_Save(View view) {
		...
		EditText     et_Payments = (EditText)findViewById(R.id.et_Payments);
		EditText     et_PrepQty = (EditText)findViewById(R.id.et_PrepQty);
		EditText     SalesOrder = (EditText)findViewById(R.id.SalesOrder);
		EditText     et_m5 = (EditText)findViewById(R.id.et_m5);
		EditText     et_m6 = (EditText)findViewById(R.id.et_m6);
		Spinner printerType = (Spinner) findViewById(R.id.sp_Print_Type);
		Spinner MobileType = (Spinner) findViewById(R.id.sp_MobileType);
	...
	/*	editor.putString("m1", et_Sal_inv.getText().toString().trim());
		...
		editor.putString("m4", SalesOrder.getText().toString().trim());
